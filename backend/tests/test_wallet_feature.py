...
BASE_URL = os.environ.get('NEXT_PUBLIC_API_URL', 'https://instant-gaming-2.preview.emergentagent.com')
...
class TestWalletPurchaseFlow:
    ...
    def test_create_purchase_checkout(self):
        ...
        response = session.post(
            ...
            json={
                "package_id": "starter",
                "origin_url": "https://instant-gaming-2.preview.emergentagent.com"
            }
        )
